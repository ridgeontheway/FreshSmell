...
import org.wasps.service.smells.concretes.DataClumpsSmell;

import java.util.ArrayList;
import java.util.List;

public class DataClumpSmellTests {
    ...
    public void DataClumpSmellTestTrue(){
        ...
        tempModel = tempSmell.smell(tempMappingProfile.map(repo.get("RandomDataClump1")).get(0));
    ...
    public void DataClumpSmellTestFalse(){
        ...
        tempModel = tempSmell.smell(tempMappingProfile.map(repo.get("RandomDataClump")).get(0));
